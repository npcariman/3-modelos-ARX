...
new_columns = {'train_meal_hov','test_meal_hov'}; % Columnas
...
for n=1:n_max_order
    ...
    B = sys.B;
    B = B(nk + 1:end);          % Eliminamos el dato extra
    ...
    Y_hat_train = ARX_k_step(data_train, theta, [na nb], k);
    Y_hat_test  = ARX_k_step(data_test,  theta, [na nb], k);
